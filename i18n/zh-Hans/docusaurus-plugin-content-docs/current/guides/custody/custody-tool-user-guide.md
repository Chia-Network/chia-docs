...
To begin the payment process, use the `cic payment` command. For this example, we'll use the following arguments (see the [CLI reference](/reference-client/cli-reference/custody-tool-cli#payment "payment command") for all options):
