...
to join a pool, enter the url (must start with _https://_), and look at the description. 如果同意, 则开始创建联合耕种农田, 并等待它被确认 (只点击一次)。这可能需要几分钟的时间才能得到确认，然后出现在“联合耕种”选项卡中。您只需要 1 个联合耕种农田。
