...
Just as in Example 1, the response includes the Offer itself at the top of the JSON output. Copy the string beginning with <code>offer1</code> and paste it into the reference wallet to verify its validity: Copy the string beginning with `offer1` and paste it into the reference wallet to verify its validity:
