...
The Offer itself is the value of `offer`, at the top of the response. It is possible to copy this string and paste it into the `Offers` dialog of the GUI. You can also send the Offer directly in an email, direct message, etc. It does not contain any sensitive information. A "thief" only has two options: accept the Offer or ignore it.
