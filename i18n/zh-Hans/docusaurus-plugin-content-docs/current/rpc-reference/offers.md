...
The information from this RPC call is all that is needed to construct an Offer to buy the NFT. For example, to offer 0.1 XCH + a fee of ten thousand mojos for this NFT, use the following command:
