...
![](/img/green-paper/table-1.png) <figcaption>Table 1: Summary of the ability to heal from malicious majority and provide security under dynamic availability of longest-chain protocols based various proof systems.</figcaption> </figure>
...
$$
{\sf PoW}_a(t_0,t_1)\ge {\sf PoW}_h(t_0,t_1)\quad\textrm{and}\quad {\sf PoW}_h(t,t_1)/D\ge k $$ <div class="eqnumber">eq.(11)</div>
...
{\sf PoST}_a(t)=space_a(t)\cdot vdf_a(t) %\item[${\cal A}_{PoST}$] $$
