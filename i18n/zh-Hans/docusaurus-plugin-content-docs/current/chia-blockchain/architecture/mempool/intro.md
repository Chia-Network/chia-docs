...
While you may be tempted to simplify your mental model of the mempool by thinking of the *default* as the *only* version, do keep in mind that some farmers will, in fact, use a customized version that doesn't follow all of (or any of) the logic discussed here.
