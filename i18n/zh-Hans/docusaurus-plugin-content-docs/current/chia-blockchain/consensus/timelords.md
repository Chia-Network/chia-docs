...
slug: /chia-blockchain/consensus/timelords
---
...
:::info
For more info, see the [Challenges page](/chia-blockchain/consensus/chains/challenges).
:::
...
Timelords also run the [three VDF chains](/chia-blockchain/consensus/chains/three-vdf-chains.md) in parallel. Therefore, at least three fast CPU cores are necessary to advance the blockchain at an efficient rate. Extra CPU cores will be necessary to create proofs, but they do not have to be as fast.
