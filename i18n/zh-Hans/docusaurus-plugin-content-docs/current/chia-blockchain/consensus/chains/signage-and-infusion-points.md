...
<figure>
<img src="/img/signage-points.png" alt="drawing"/><figcaption>
...
2. Two VDF proofs have been included: one from `r1` to the signage point and one from `r1` to `b1`. (Actually it's more since there are three VDF chains, explained in [Section 3.8](/chia-blockchain/consensus/chains/three-vdf-chains.md) 'Section 3.8: Three VDF Chains')).
