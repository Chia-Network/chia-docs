...
是的。 The maximum strength will start at 8, and will increment as the base filter is decreased. Strength needs to be capped in order to ensure that the network’s minimum spec hardware can validate all proofs in a timely manner.
...
| Block height | 年份   | Base Filter Bits | Base Filter |
| :----------- | :--- | :--------------- | :---------- |
