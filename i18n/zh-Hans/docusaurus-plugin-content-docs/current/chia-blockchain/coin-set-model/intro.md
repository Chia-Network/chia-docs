...
slug: /chia-blockchain/coin-set-model/intro
---
...
The differences between the above models will be covered in the [Coin Set vs UTXO page](/chia-blockchain/coin-set-model/coin-set-vs-utxo) and the [Coin Set vs Account page](/chia-blockchain/coin-set-model/coin-set-vs-account). For now, we'll start with a brief explanation of the coin set model.
...
You can read more on the [Spend Bundle page](/chia-blockchain/coin-set-model/spend-bundles).
