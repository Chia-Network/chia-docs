...
有了这种共识机制，攻击网络就变得非常困难。如果攻击者想通过创建替代区块链来“重写历史”，他们需要比系统中的诚实参与者更快地创建新区块。由于创建每个区块所需的工作量证明，攻击者需要比网络中所有其他计算机的总和更快地生成哈希。这被称为“51% 攻击”，稍后将在[第 3.14 节](/consensus/attacks_and_countermeasures 'Section 3.14: Attacks and Countermeasures')中进行更详细的讨论。
...
> 有关奇亚交易池的更多信息，请参阅[第 6 节](/mempool/mempool "Section 6: Chia's Mempool")。
...
> For more info on Chia's mempool, see [Section 6](/mempool/mempool "Section 6: Chia's Mempool").
