...
:::info If you are unsure of how to run the commands from this step, you can reboot your computer and proceed to the [Next step after stopping Chia](#next-step-after-stopping-chia). :::
