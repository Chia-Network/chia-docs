...
:::info
**信息**<br />
[CAT1](https://chialisp.com/docs/puzzles/cats) 将在 2311760 区块高度结束其生命周期，也就是 UTC 时间 2022 年 7 月 26 日 17:00。更多关于结束生命周期的信息可以参考 CAT2 介绍及[FAQ](/docs/cat2/cat2-intro#常见问题).
:::
