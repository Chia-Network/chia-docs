...
Chia is a cryptocurrency and blockchain with smart transaction capabilities. Its [PoST consensus](/docs/consensus-overview) is the first (and only) Nakamoto consensus since Proof of Work, and has a much [lower energy consumption](https://chiapower.org/).
...
<Tabs
  ...
  groupId="install"
  values={[
    {label: 'Official installer', value: 'installer'},
    {label: 'Dev builds', value: 'dev'},
...
- [macOS Intel](https://download.chia.net/latest/Setup-MacOS.dmg) _Catalina 10.15 and later_
- [macOS Intel](https://download.chia.net/install/Chia-1.5.0-10.14-intel.dmg) _Mojave 10.14_
...
- [Windows](https://download.chia.net/latest-dev/ChiaSetup-latest-dev.exe)
- [macOS Apple Silicon](https://download.chia.net/latest-dev/Chia-arm64_latest_dev.dmg)
- [macOS Intel](https://download.chia.net/latest-dev/Chia-intel_latest_dev.dmg) _Catalina 10.15 and later_
- [Ubuntu/Debian](https://download.chia.net/latest-dev/chia-blockchain_amd64_latest_dev.deb)
- [Ubuntu/Debian ARM](https://download.chia.net/latest-dev/chia-blockchain_arm64_latest_dev.deb)
- [CentOS/Redhat](https://download.chia.net/latest-dev/chia-blockchain-1.x86_64_latest_dev.rpm)
...
[Get plotting now](/docs/)

### Start Farming

Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.

[Get farming now](/docs/)

### Run a Node

Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.

[Start running a node now](/docs/)

### Build on Chia

Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.

[Start building on Chia today](/docs/)
...
Reference our [plotting guide](/docs/plotting-basics) for more details.
...
The Node has an [RPC interface](/docs/rpc-api). This RPC will allow you to interact with the Chia node through code.
