...
Using the CLI with Chia gives you greater and more precise control. For a more details on the commands, read the [CLI Commands Reference](/clis).
...
For more information you can read the [CLI Commands Reference page](/clis).
...
The Node has an [RPC interface](/full-node-rpcs). This RPC will allow you to interact with the Chia node through code.
