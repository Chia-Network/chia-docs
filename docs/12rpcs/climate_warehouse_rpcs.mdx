---
id: climate_warehouse_rpcs
title: Climate Warehouse RPCs
sidebar_label: 12.4 Climate Warehouse RPCs
sidebar_position: 4
---
...
Functionality: Use GET, POST, and DELETE to add, delete and list files from your organization
...
### Upload a new file to a local org
...
| :----- | :----- | :------- | :---------------------------------------------------------------------------------------------------------------- |
| fileId | String | True     | The SHA-256 hash of the file to download, obtainable by running [this RPC](#get-a-list-of-files-in-the-local-org) |
...
| Key    | Type   | Required | Description                                                                                                       |
| :----- | :----- | :------- | :---------------------------------------------------------------------------------------------------------------- |
| fileId | String | True     | The SHA-256 hash of the file to delete, obtainable by running [this RPC](#get-a-list-of-files-in-the-local-org) |
...
:::info
You must have permission to run this RPC. If you do not have permission, you will receive an error message such as the one from the example.
:::
...
```json
{"message":"Cant create Governance Body","error":"You are not an governance body and can not use this functionality"}
```
...
```json
{"message":"Cant update default orgs","error":"There is no Goverance Body that you own that can be edited"}
```
...
:::info
You must be the owner of a governance body to run this RPC. If you are not, you will receive an error message such as the one from the example.
:::
...
```json
{"message":"Cant update picklist","error":"There is no Goverance Body that you own that can be edited"}
```
...
```json
{"message":"New organization created successfully.","orgId":"25824d086ec55565aca6149d463fae9d37457adc4b5ea2f49e6752d8c668b99b"}
```
...
This RPC must be called before subcribing to an organization. The following keys are required for this RPC:
...
You must wait for the transation to be confirmed on the blockchain before subscribing to the organization.
...
:::note
You must have previously [imported](#import-an-external-organization) this organization in order to subsribe to it.
:::
...
```json
{"message":"Project staged successfully","uuid":"6c06c2ca-453d-4f32-b9cd-0641aa293b8e"}
```
...
```json
{"message":"Unit staged successfully","uuid":"9137b39c-603a-472d-aa8d-c2a0a88f8401"}
```
...
```json
{"message":"Unit staged successfully","uuid":"8240b643-cacf-4218-bb25-d1a48c791a66"}
```
        ...
        "change":[
          {
            ...
            "unitOwner":"Chia",
            "countryJurisdictionOfOwner":"Andorra",
            "unitCount":100,"unitBlockEnd":"ABC200",
            "unitBlockStart":"ABC100",
            "vintageYear":1998,
            "unitType":"Removal - technical",
            "unitStatus":"Held",
