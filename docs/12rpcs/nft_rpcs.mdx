...
```powershell  
C:\>chia rpc wallet create_new_wallet '{\"wallet_type\": \"nft_wallet\"}'
```
...
```json
(venv) PS C:\Users\User\Chia\release_1.4.0\2022_06_17\chia-blockchain> chia rpc wallet nft_get_nfts '{"wallet_id": 4}'
{
    "nft_list": [
        {
