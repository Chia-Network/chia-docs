...
```powershell  
(venv) C:\> chia rpc wallet create_new_wallet '{\"wallet_type\": \"nft_wallet\"}'
```
...
Example 1 - Mint an NFT without using a DID:
...
```json
// Request
(venv) $ chia rpc wallet nft_transfer_nft '
{
    "wallet_id": 2, 
...
```json
// Request
(venv) $ chia rpc wallet nft_get_info '{
    "wallet_id": 4, 
...
```json
// Request
(venv) $ chia rpc wallet nft_add_uri '
{
    "wallet_id": 4, 
    "nft_coin_id": "0x9bcf429079bd8e394658a3f0c43c6641c9f92d0dcc1770eeb6be6588a49fc925", 
    "key": "mu", 
...
```json
(venv) $ chia rpc wallet nft_get_nfts '{"wallet_id": 4}'
{
    "nft_list": [
        {
