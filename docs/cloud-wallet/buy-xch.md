...
3. Enter the amount you want to purchase in USD. The minimum is \$25 and the maximum is \$2500, then click `Next`:
...
- Verify your purchase amount is between \$25 and \$2500
