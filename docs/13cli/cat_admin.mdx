---
id: cat_admin_cli
title: CAT Admin Tool CLI Reference
sidebar_label: 13.5 CATs CLI Reference
sidebar_position: 5
---
...
To set up your environment (including installing this tool), follow our CATs guide for [Linux/MacOS](https://chialisp.com/docs/tutorials/CAT_Launch_Process_Linux_MacOS) and [Windows](https://chialisp.com/docs/tutorials/CAT_Launch_Process_Windows).
