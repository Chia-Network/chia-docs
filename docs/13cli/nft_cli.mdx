...
| -h            | --help                        | None    | False    | Show a help message and exit |
| -sn [(WARNING)](#editions-and-series) | --series-number               | INTEGER | False    | The **edition** number. Specify if this NFT has multiple editions (multiple identical copies of an NFT). [default: 1] |
| -st [(WARNING)](#editions-and-series) | --series-total                | INTEGER | False    | The **edition** total number. Specify if this NFT has multiple editions. [default: 1] |
