...
sidebar_label: 13.3 NFT CLI Reference
sidebar_position: 3
---
...
| -sn (deprecated) | --series-number (deprecated)  | INTEGER | False    | Beginning in Chia version 1.5, please use `en` (`edition-number`) instead                                         |
| -st (deprecated) | --series-total (deprecated)   | INTEGER | False    | Beginning in Chia version 1.5, please use `ec` (`edition-count`)                                                  |
