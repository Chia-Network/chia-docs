...
```powershell
(venv) PS C:\Users\User\Chia\release_1.4.0\2022_06_17\chia-blockchain> chia wallet nft list -i 2
...
| -wp           | --wallet-rpc-port | INTEGER | False    | Set the port where the Wallet is hosting the RPC interface. See the rpc_port under wallet in config.yaml |
| -f            | --fingerprint     | INTEGER | False    | Set the fingerprint to specify which wallet to use |
| -ni           | --nft-coin-id     | TEXT    | True     | Id of the NFT coin for which to sho info |
| -h            | --help            | None    | False    | Show a help message and exit |
...
[todo this tx goes through, but it doesn't actually set the did yet]

```powershell
(venv) PS C:\Users\User\Chia\release_1.4.0\2022_06_17\chia-blockchain> chia wallet nft set_did -i 2 -di did:chia:16kgxghw80cjlytl7x7zxuuux32v308fnmcgkfrh652rtcdqexm4q7gsarr -ni 6052a11829c20e9fb9c8fd66b38565e1fcfdedae3d3b410dfb6caef363fb22d8
