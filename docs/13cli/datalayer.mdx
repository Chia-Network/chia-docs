...
sidebar_label: 13.2 DataLayer CLI Reference
sidebar_position: 2
---
...
Commands that modify the blockchain include an optional XCH fee, which can be added by using the `-m` / `--fee` parameter to the command.
