...
* [CLI reference](/docs/15resources/custody_tool_cli_reference) for all custody commands used in this tutorial
...
If you plan to run the custody tool on testnet10 (as opposed to running it on a custom testnet), then you'll need to do six steps before proceeding:
1. Install Chia from source
2. Change your configuration to use the testnet
3. Add a new key pair
4. Start and sync your wallet
5. Add some TXCH to your wallet
6. Sync your node
...
6. Install the custody tool
    ...
    * Next, run the command listed in the repo's readme under [HSMS Install](https://github.com/Chia-Network/internal-custody#hsms-install). Currently (May 2022) this command is `pip install git+https://github.com/Chia-Network/hsms.git@main#1c6122bebf482e8ee777f5c401eb16ac2ffca68c`. This command is subject to change, so you should consider the above link to be the source of truth
