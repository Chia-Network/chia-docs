...
Using notation from §[7.1.1](#S:RBB){reference-type="ref" reference="S:RBB"}, for a PoW based chain that means that for some $f>1$ (that captures the advantage of the honest parties) and any time $t$ we have 
