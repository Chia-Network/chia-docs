...
- [Basic description](/prefarm-custody) of how the custody tool works, in plain English
...
- [CLI reference](/custody-tool-cli) for all custody commands used in this tutorial
...
For more info, see the [CLI reference](/custody-tool-cli#export_config).
