...
- [Basic description](/prefarm-custody/prefarm_custody_english) of how the custody tool works, in plain English
...
- [CLI reference](/prefarm-custody/custody_tool_cli_reference) for all custody commands used in this tutorial

There are two basic paths you can take for testing:

1. **[Install and run a custom testnet.](/prefarm-custody/custom_testnet_configuration)** You will be given the entire prefarm for this testnet. Yes, you will actually own 21 million (T)XCH!
...
2. **[Run on testnet10](/prefarm-custody/testnet10_configuration)**
...
For more info, see the [CLI reference](/prefarm-custody/custody_tool_cli_reference#export_config).
...
:::info
About the [examine_spend](/prefarm-custody/custody_tool_cli_reference#examine_spend) command:
