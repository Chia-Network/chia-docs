...
- **Codebase**: Access to the [chia-gaming repository](https://github.com/Chia-Network/chia-gaming) or the required Docker images
...
- **Developer Side**:
  ...
  - Network access to coinset.org
  - Sufficient resources to run Docker containers

- **User Side**:
  - Chia Light Wallet (Chia 2.5.7)
  - Modern web browser
...
3. **Manual Configuration**: See the [Manual Configuration](#manual-configuration) section below for details on updating network settings, WalletConnect project info, ports, and domain.
...
1. **agg_sig_additional change to testnet constant**:
   ...
   - Location: Line 32
   - Update the `agg_sig_additional` constant to the testnet value: `e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855`
...
3. **coinset URL for testnet (Content Security Policy 1)**:
   - File: `resources/nginx/game.conf`
   - Location: Line 17
   - Update the coinset URL in the Content Security Policy header to the testnet endpoint: `https://testnet11.api.coinset.org`
   - [View in repository](https://github.com/Chia-Network/chia-gaming/blob/e716262cdf907e007af26c137a90f50d25ffa344/resources/nginx/game.conf#L17)

4. **coinset URL for testnet (Content Security Policy 2)**:
   - File: `resources/lobby-service/src/index.ts`
   - Location: Line 48
   - Update the coinset URL in the Content Security Policy header to the testnet endpoint: `https://testnet11.api.coinset.org`
   - [View in repository](https://github.com/Chia-Network/chia-gaming/blob/e716262cdf907e007af26c137a90f50d25ffa344/resources/lobby-service/src/index.ts#L48)
