...
California Poker is a card game where players exchange cards and compete to make the best five-card poker hand. Each player receives 8 cards, selects 4 to keep, and sends the other 4 to their opponent. The player who can make the best five-card poker hand from their 8 cards wins.

## Setup

- Each player receives 8 cards, all shown face up
- Cards are displayed sorted in rank order
- Each possible set of cards is equally likely to be dealt

## Gameplay

### Card Selection Phase

1. Both players view their 8 cards simultaneously
2. Each player selects 4 cards to keep
3. The 4 cards not selected are automatically sent to the opponent
4. Players wait for their opponent to complete their selection (this step may be skipped if the opponent finishes first)
...
2. **Card Selection**: Each player picks 4 cards to keep
