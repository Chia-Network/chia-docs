...
Being a known community member - the better you're known (pseudonymously is fine) - the more likely you are to be added. You should be on [Keybase](https://keybase.io/team/chia_network.public) and we will need to know your Keybase handle as you will be added to a seeder operators closed channel.
