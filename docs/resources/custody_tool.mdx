...
- [Basic description](resources/custody-tool-description) of how the custody tool works
- [Flow chart](/img/chia_custody_tool.png) to visualize how the custody tool works
- [CLI reference](cli-reference/custody-tool) for all custody commands used in this tutorial

There are two basic paths you can take for testing:

1. **[Install and run a custom testnet.](/install-custom-testnet)** You will be given the entire prefarm for this testnet. Yes, you will actually own 21 million (T)XCH!
...
2. **[Run on testnet10](/prefarm-custody-testnet10)**
...
```powershell
(venv) PS C:\Users\User\prefarm_test\keys_and_sb> cic init --directory $(pwd) --date 1653449948 -r 10000000000000 -a 10000000000000000000 -wt 600 -pc 1200 -rt 300 -rc 600 -sp 900
...
For more info, see the [CLI reference](cli-reference/custody-tool#export_config).
