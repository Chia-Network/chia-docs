...
# Harvester Algorithm
Approximately every 9.8 seconds, the full node sends a new signage point to the farmer, who sends it to each harvester.
...
This is where the majority of the disk activity will be. About 1/512 plots will pass this step.
...
5. For winning proofs. the whole proof is fetched on disk (approximately 64 random reads).
