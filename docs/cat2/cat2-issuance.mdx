...
:::info
[CAT1](https://chialisp.com/docs/puzzles/cats) will reach its end of life at block 2,311,760, which will occur on July 26, 2022 at around 17:00 UTC.
...
8. The final step is to create the coin using the `secure the bag root address` as the target address.
    ...
    The command to run is (Note that you need the parentheses after `curry command output`):
