...
1. Figure out the total number of XCH mojos that were issued for your CAT1. If you already know this number, then you can skip this step.
   ...
   - You'll see _Supply_ (and a number) under the title on the right side of your screen. The number indicates the number of kens issued. However, you need to multiply this number by 1,000 in order to calculate the number of XCH mojos used for e issuance. For example, Spacebucks had an issuance of 1 billion (1,000,000,000) tokens, which is equivalent to 1 illion (1,000,000,000,000) XCH mojos.
