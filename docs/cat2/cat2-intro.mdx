...
Check out [the developer docs](cat2-snapshot) to get started with issuing your CAT2 tokens.
:::
...
[Follow this document](cat2-snapshot), which will guide you through the process of reissuing your token as a CAT2.
