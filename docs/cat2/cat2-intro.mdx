...
Check out the [Snapshot Generation page](/docs/cat2-snapshot) to get started with issuing your CAT2 tokens.
:::
...
[Follow this document](/docs/cat2-snapshot), which will guide you through the process of reissuing your token as a CAT2.
